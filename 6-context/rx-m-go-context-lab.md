...
> N.B. If you have not installed Go on your lab system you can run the rx-m go script to install and configure the
> latest version: curl https://raw.githubusercontent.com/RX-M/classfiles/master/go.sh | bash
